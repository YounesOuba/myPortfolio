...
function Section2() {
    ...
    return (
        <section className="ndSection w-full h-screen flex mt-36">
            <div className="ndDiv relative flex flex-col w-3/4 mx-auto"
            data-aos="zoom-in"
            >
                ...
                <div className="aboutContainer flex items-center gap-5"
                data-aos="fade-up"
                >
                    <p className="ndText bg-slate-400/10 text-gray-300 mb-4 mt-12 w-2/4 rounded-2xl backdrop-blur-lg px-8 py-20"
                        data-aos="flip-left"
                        data-aos-offset="-100"
                        data-aos-delay="50"
                        data-aos-duration="600"
                    ...
                    data-aos-anchor-placement="top-center"
                    >
                    <h3 className="right-0 flex mb-5 text-2xl font-extrabold" data-aos="zoom-out">what do i do right now?</h3>
                    Currently, I am focused on developing dynamic and responsive websites. My work involves both front-end and back-end 
                    development, utilizing a wide range of technologies. I enjoy creating user-friendly interfaces and building functional 
                    web applications that offer smooth user experiences. I am committed to continuously enhancing my skills and keeping up 
                    with the latest trends and technologies in web development.
                    </p>
                </div>
            </div>
        </section>
